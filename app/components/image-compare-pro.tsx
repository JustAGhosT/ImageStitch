    ...
    <TooltipProvider>
      <div className="h-screen bg-gradient-to-br from-[#0B1120] to-[#101828] text-white flex overflow-hidden">
        ...
        <div className="w-64 bg-[#0B1120]/80 border-r border-[#00E5FF]/15 flex flex-col">
          ...
          {/* Upload Section */}
          <div className="p-6 border-b border-[#00E5FF]/15">
            <h3 className="text-sm font-medium text-gray-300 mb-4 uppercase tracking-[0.2px]">Upload Images (2-6)</h3>
            <div
          ...
          {/* Comparison Mode */}
          <div className="p-6 border-b border-[#00E5FF]/15">
            <h3 className="text-sm font-medium text-gray-300 mb-4 uppercase tracking-[0.2px]">Comparison Mode</h3>
            <div className="flex rounded-lg bg-[#101828] p-1">
              {(["overlay", "split", "slider"] as ComparisonMode[]).map((mode) => (
                <button
                  key={mode}
                  onClick={() => setComparisonMode(mode)}
                  className={`flex-1 px-3 py-2 text-xs font-medium rounded-md transition-all duration-200 ease-out capitalize ${
                    comparisonMode === mode
          ...
          {/* Drawing Tools */}
          <div className="p-6 border-b border-[#00E5FF]/15">
            <h3 className="text-sm font-medium text-gray-300 mb-4 uppercase tracking-[0.2px]">Drawing Tools</h3>
                  ...
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={`p-3 rounded-lg border transition-all duration-200 ease-out ${
                        selectedTool === tool
                          ? "bg-[#00E5FF]/20 border-[#00E5FF]/40 text-[#00E5FF] shadow-lg shadow-[#00E5FF]/10"
                          : "bg-[#101828] border-[#00E5FF]/15 text-gray-400 hover:text-gray-300 hover:border-[#00E5FF]/25 hover:shadow-md"
                      }`}
                    >
            ...
            <div className="space-y-3">
              <label className="text-xs text-gray-400 uppercase tracking-[0.2px]">Stroke Width</label>
              <Slider
                value={[strokeWidth]}
            ...
            {/* Color Picker */}
            <div className="mt-4">
              <label className="text-xs text-gray-400 uppercase tracking-[0.2px] mb-2 block">Color</label>
              <div className="w-8 h-8 rounded-lg bg-[#00E5FF] border border-[#00E5FF]/40 cursor-pointer shadow-lg shadow-[#00E5FF]/20"></div>
            </div>
          </div>

          {/* Export */}
          <div className="p-6 mt-auto">
            <Button className="w-full bg-[#00E5FF]/20 hover:bg-[#00E5FF]/30 text-[#00E5FF] border border-[#00E5FF]/40 transition-all duration-200 ease-out hover:shadow-lg hover:shadow-[#00E5FF]/20">
          ...
          <div className="bg-[#0B1120]/60 border-b border-[#00E5FF]/15 p-4 flex items-center justify-between">
            <div className="flex items-center space-x-4">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      variant="ghost"
                      size="sm"
                      className="text-gray-400 hover:text-[#00E5FF] transition-colors duration-200"
                    >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-400 min-w-[60px] text-center font-mono">{zoom}%</span>
                <Button
                  variant="ghost"
                  size="sm"
                ...
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={`transition-colors duration-200 ${
                      showGrid ? "text-[#00E5FF] shadow-lg shadow-[#00E5FF]/10" : "text-gray-400"
                    } hover:text-[#00E5FF]`}
                  >
            ...
            <div
              ...
              style={{
                backgroundImage: showGrid
                  ? `radial-gradient(circle, rgba(0, 229, 255, 0.1) 1px, transparent 1px)`
                  : "none",
